...
export default function App() {
  ...
  const [results, setResults] = useState<{ scores: any; recommendation: any } | null>(null);
                  ...
                  <div className="flex flex-col lg:flex-row gap-20 items-center">
                    <div className="flex-1">
                      <div className="inline-flex items-center gap-3 px-4 py-2 rounded-sm bg-teal/5 border border-teal/10 mb-10">
                        ...
                        <span className="font-tech text-xs font-bold uppercase tracking-[0.3em] text-teal">Strategic Roadmap // Recommended</span>
                      </div>
                      ...
                      <div className="grid sm:grid-cols-2 gap-8 mb-16">
                        {results.recommendation.objectives.map((obj: string, i: number) => (
                      ...
                      <div className="flex flex-col sm:flex-row gap-8 items-center">
                        ...
                        <div className="flex items-center gap-4 text-dark/60">
                          ...
                          <span className="font-tech text-xs font-bold uppercase tracking-[0.2em]">{results.recommendation.date}</span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="w-full lg:w-96 shrink-0">
                      <div className="bg-teal/5 border border-teal/10 p-10 rounded-3xl relative">
                        ...
                        <div className="flex items-center gap-5 mb-10">
                          <img src="https://picsum.photos/seed/joanne/200/200" className="w-20 h-20 rounded-xl object-cover grayscale" referrerPolicy="no-referrer" />
                          <div>
                            <div className="font-display text-xl uppercase text-dark">Joanne Sison</div>
